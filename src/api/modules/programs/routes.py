...
program_exercise_model = programs_ns.model('ProgramExercise', {
...
program_section_model = programs_ns.model('ProgramSection', {
...
program_model = programs_ns.model('Program', {
...
class Program(Resource):
    ...
    @programs_ns.expect(program_model, validate=True)
    @programs_ns.response(201, 'Program created successfully')
    @require_api_key
    def post(self):
        return programs_service.create_program(programs_ns.payload)
